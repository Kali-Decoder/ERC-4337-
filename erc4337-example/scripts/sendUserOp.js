...
async function main() {
    ...
    console.log(`The balance of the signer is: ${balanceWei} Wei ${signer.address}`);

    const funcTargetData = exampleContract.interface.encodeFunctionData('increamentCounter');

    const data = simpleAccount.interface.encodeFunctionData('execute', [exampleContractAddress, 0, funcTargetData]);

    console.log('data:', funcTargetData);
